...
export const HumanVerificationShowcase = () => {
  return (
              ...
              <div className="flex-1 rounded-t-[10px] bg-white p-4">
                ...
                <div className="mx-auto max-w-md">
                  ...
                  <p className="mb-2 text-gray-600">
                    ...
                    <a href="https://www.uilabs.dev/">uilabs.dev</a>.
                  </p>
                  <p className="mb-2 text-gray-600">
                    Tbh I kinda tried to replicate it to see if I can build such
                    interaction and it was fun building it.
                  </p>
                </div>
              </div>
            </Drawer.Content>
